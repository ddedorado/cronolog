...
export function useAuth() {
  ...
  async function init() {
    ...
    try {
      // getSession() awaits Supabase's internal initialization, which includes
      // auto-detecting ?code= from PKCE OAuth redirects in the query string.
      // PKCE codes in the query string are not affected by hash-based routing.
